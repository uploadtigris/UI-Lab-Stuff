...
def ttl_avg_price(zip_ttlbought_long_df, model_price_long_df):
    ...
    #filter for MODEL == Tesla, Chevrolet, BMW, Jeep, Ford
    merged_df = merged_df[(merged_df['MAKE'] == 'Tesla') | (merged_df['MAKE'] == 'Chevrolet') | (merged_df['MAKE'] == 'BMW') | (merged_df['MAKE'] == 'Jeep') | (merged_df['MAKE'] == 'Ford')]
...
def main():
    ...
    phev_result_df = total_Vehicles(zip_ttlbought_long_df, model_price_long_df, 'PHEV')
    bev_result_df = total_Vehicles(zip_ttlbought_long_df, model_price_long_df, 'BEV')
    hev_result_df = total_Vehicles(zip_ttlbought_long_df, model_price_long_df, 'HEV')
    ...
    phev_price_avg = avg_price_by_type(zip_ttlbought_long_df, model_price_long_df, phev_result_df, 'PHEV')
    bev_price_avg = avg_price_by_type(zip_ttlbought_long_df, model_price_long_df, bev_result_df, 'BEV')
    hev_price_avg = avg_price_by_type(zip_ttlbought_long_df, model_price_long_df, hev_result_df, 'HEV')
    ttl_price_avg = ttl_avg_price(zip_ttlbought_long_df, model_price_long_df)
    ...
    file_path = 'CSVs\\TotalVehiclesByMake_TCBJF.csv'
