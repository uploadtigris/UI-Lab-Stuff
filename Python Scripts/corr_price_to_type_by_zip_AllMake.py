...
def avg_price_by_type(new_merged_df, vehicle_type):
...
def main():
    ...
    phev_result_df = total_Vehicles(merged_df, 'PHEV')
    bev_result_df = total_Vehicles(merged_df, 'BEV')
    hev_result_df = total_Vehicles(merged_df, 'HEV')
    ...
    print('new merged', merged_df)
    print('zip result', phev_result_df)

    phev_price_avg = avg_price_by_type(merged_df, phev_result_df, 'PHEV')
    bev_price_avg = avg_price_by_type(merged_df, bev_result_df, 'BEV')
    hev_price_avg = avg_price_by_type(merged_df, hev_result_df, 'HEV')
    ttl_price_avg = ttl_avg_price(merged_df)
    ...
    file_path = '/Users/tigris/Documents/UI Lab/Jun EV Task/Correlation_Analysis/CSVs\TotalVehiclesByMake_AllMake.csv'
