...
def main():
    ...
    new_merged_df = merged_df[(merged_df['MAKE'] == 'Tesla')]
    ...
    file_path = '/Users/tigris/Documents/UI Lab/Jun EV Task/Correlation_Analysis/CSVs\TotalVehiclesByMake_Tesla_ONLY.csv'
