...
def main():
    avg_prices = pd.read_csv(r'/Volumes/ESD-USB/Jun EV Task/Correlation_Analysis/CSVs/avg_price_by_type.csv')
    print(avg_prices)
    ...
    avg_prices_phev = avg_prices[(avg_prices['AVG_PRICE_PHEV'] > 5000) & (avg_prices['AVG_PRICE_PHEV'] < 100000)]
