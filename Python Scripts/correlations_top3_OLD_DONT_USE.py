...
def main():
    ...
    plt.title('Average PHEV Price vs. Number of PHEV Vehicles Tesla, Chevy, Nissan ONLY')
    ...
    plt.title('Average BEV Price vs. Number of BEV Vehicles Tesla, Chevy, Nissan ONLY')
    ...
    plt.title('Overall Average Price vs. Number of TOTAL EV Vehicles Tesla, Chevy, Nissan ONLY')
