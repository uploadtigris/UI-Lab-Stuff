...
def main():
    avg_prices = pd.read_csv(r'/Volumes/ESD-USB/Jun EV Task/Correlation_Analysis/CSVs\avg_price_by_type_make_only_001.csv')
    print(avg_prices)
    ...
    avg_prices_phev = avg_prices_phev[(avg_prices_phev['AVG_PRICE_PHEV'] > 5000) & (avg_prices_phev['AVG_PRICE_PHEV'] < 120000)]
    ...
    plt.title('Average PHEV Price (avg. Make Price) vs. Number of PHEV Vehicles')
    ...
    plt.title('Average BEV Price (avg. Make Price) vs. Number of BEV Vehicles')
    ...
    plt.title('Overall Average Price (avg. Make Price) vs. Number of TOTAL EV Vehicles')
