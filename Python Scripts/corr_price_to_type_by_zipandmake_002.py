...
def main():
    ...
    model_price_wide_df = pd.read_csv('/Volumes/ESD-USB/Jun EV Task/Correlation_Analysis/CSVs/MODEL_PRICE_WATERFALL_MAKE_AVG.csv')
    ...
    # print('sanity check', model_price_long_df)
    ...
    zip_totalbought_wide_df.to_csv('CSVs\\avg_price_by_type_make_only_001.csv', index=False)
    ...
    file_path = 'CSVs\\avg_price_by_type_make_only_001.csv'
