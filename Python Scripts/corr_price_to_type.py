...
wide_df = pd.read_csv('E:/Jun EV Task/Correlation_Analysis/CSVs/unfiltered_zip_type.csv')

#Melt HEV, PHEV, and BEV into a single column
long_df = wide_df.melt(id_vars=['MODEL', 'MAKE', 'PRICE', 'ttl_bought'], 
...
long_df['ttl_bought'].fillna(0, inplace=True)

# Drop rows with no Price
filtered_df = long_df[long_df['PRICE'] != 0]

filtered_df['ttl_bought'].fillna(0, inplace=True)
...
# print("Pearson Correlation Coefficient:", bev_corr)
...
# print("Pearson Correlation Coefficient:", phev_corr)
# print("P-value:", p_value)
...
print("Pearson Correlation Coefficient:", hev_corr)
print("P-value:", p_value)
